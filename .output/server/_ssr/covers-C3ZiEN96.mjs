//#region node_modules/.nitro/vite/services/ssr/assets/covers-C3ZiEN96.js
var COVERS = {
	clarte: "/assets/cover-clarte-BVA7CsdH.jpg",
	traction: "/assets/cover-traction-CJ1WXj0k.jpg",
	lettres: "/assets/cover-lettres-DMR-OFK4.jpg"
};
function coverFor(key) {
	return key && COVERS[key] || "/assets/cover-clarte-BVA7CsdH.jpg";
}
var FOUNDER = {
	name: "Prisca Brou",
	role: "Anthropologue, coach & fondatrice",
	honor: "Docteur Honoris Causa d'université · Mère de 4 enfants",
	tagline: "Elle croit en une éducation des adultes ancrée dans l'innovation sociale et la participation communautaire, comme levier d'autonomie, de résilience et de développement durable.",

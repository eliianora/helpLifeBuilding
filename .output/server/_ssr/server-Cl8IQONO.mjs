...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-BGNRYVo7.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B7HW3MCU.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BLxHm9iI.mjs"),
		import("./start-CEf1r6d8.mjs"),

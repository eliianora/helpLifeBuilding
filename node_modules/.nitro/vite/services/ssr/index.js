...
function getSupabasePublicEnv() {
	const viteUrl = typeof import.meta !== "undefined" ? "https://test.supabase.co" : void 0;
	const viteKey = typeof import.meta !== "undefined" ? "sb_publishable_testtesttest" : void 0;
...
async function getServerEntry() {
	if (!serverEntryPromise) serverEntryPromise = import("./assets/server-DKKci9Wn.js").then((m) => m.default ?? m);

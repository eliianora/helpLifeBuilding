import { t as supabase } from "./client-DqaBVmPg.js";
import { r as slugify } from "./admin-Bv8g1X24.js";
import { t as Button } from "./button-CWkTyF61.js";
import { n as adminLegacyList } from "./admin-legacy.functions-BrQcRsM7.js";
import { t as Input } from "./input-Oigv6AWn.js";
import { t as Label } from "./label-DWmshiB9.js";
import { t as Textarea } from "./textarea-B-JceDfa.js";
import { a as adminListEbooks, d as adminUploadEbookPdf, l as adminSaveEbook, n as adminDeleteEbook } from "./admin.functions-D3nCuUqe.js";
import { useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { toast } from "sonner";
import { FileText, Upload } from "lucide-react";
//#region src/routes/admin/ebooks.tsx?tsr-split=component
var emptyForm = () => ({
	title: "",
	slug: "",
	subtitle: "",
...
function AdminEbooks() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			!isLoading && !error && data.length === 0 ? /* @__PURE__ */ jsx("p", {
			...
			data.length ? /* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("table", {
					...
					}), /* @__PURE__ */ jsx("tbody", { children: data.map((ebook) => /* @__PURE__ */ jsxs("tr", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("label", {
								...
								children: [/* @__PURE__ */ jsx(Upload, {
									...
									"aria-hidden": true
								}), /* @__PURE__ */ jsx("span", { children: pdfFile ? `${pdfFile.name} (${(pdfFile.size / 1024 / 1024).toFixed(1)} Mo)` : form.fichier_url ? "Remplacer le PDF actuellement chargé" : "Choisir un PDF depuis l’ordinateur (50 Mo maximum)" })]
							}),
							/* @__PURE__ */ jsx("input", {
								id: "ebook-pdf",
								className: "sr-only",
							...
							form.fichier_url ? /* @__PURE__ */ jsxs("p", {

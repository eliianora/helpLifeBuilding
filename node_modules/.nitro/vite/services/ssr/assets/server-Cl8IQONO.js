...
import { t as getServerFnById } from "./__23tanstack-start-server-fn-resolver-BGNRYVo7.js";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-B7HW3MCU.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BLxHm9iI.js"),
		import("./start-CEf1r6d8.js"),

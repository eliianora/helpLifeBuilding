...
var getErrorMessage = (type, cause) => import.meta.env.PROD ? getErrorMessageProd(type) : getErrorMessageDev(type, cause);
...
var SerovalMode = /* @__PURE__ */ function(SerovalMode) {
